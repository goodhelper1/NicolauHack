...
{
	public class NicolauSkin : ContainerControl
	{
		private int W;
		private int H;
		...
		[Category("Colors")]
		public Color NicolauColor
		{
			// get { return Helpers.NicolauColor; }
			// set { Helpers.NicolauColor = value; }
			get { return _NicolauColor; }
			set { _NicolauColor = value; }
		}
		...
		private Color _NicolauColor = Helpers.NicolauColor;
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			_with2.FillRectangle(new SolidBrush(NicolauColor), 16, 16, 4, 18);
