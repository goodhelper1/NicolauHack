...
namespace NicolauTheme
{
	...
	public class NicolauRadioButton : Control
	{
		...
		private void InvalidateControls()
		{
			...
			{
				if (!object.ReferenceEquals(C, this) && C is NicolauRadioButton)
				{
					((NicolauRadioButton)C).Checked = false;
					Invalidate();
				}
			}
		}
		...
		private Color _BorderColor = Helpers.NicolauColor;
		private Color _TextColor = Color.FromArgb(243, 243, 243);

		public NicolauRadioButton()
		{
